...
WMFileSystemStorage["prototype"] = {
    ...
    "store":        WMFileSystemStorage_store,  // WMFileSystemStorage#store(key:String, blob:Blob, mime:MimeTypeString, size:Integer, callback:Function):void
...
// put file
function WMFileSystemStorage_store(key,        // @arg String
                                   blob,       // @arg Blob
