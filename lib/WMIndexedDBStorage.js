...
WMIndexedDBStorage["prototype"] = {
    ...
    "store":        WMIndexedDBStorage_store,   // WMIndexedDBStorage#store(key:String, data:Blob|ArrayBuffer, mime:MimeTypeString, size:Integer, callback:Function):void
...
function WMIndexedDBStorage_store(key,        // @arg String
