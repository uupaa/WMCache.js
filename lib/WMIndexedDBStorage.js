...
WMIndexedDBStorage["prototype"] = {
    ...
    "size":         WMIndexedDBStorage_size,    // WMIndexedDBStorage#size():Integer
...
function WMIndexedDBStorage_size() {
    return this._size;
}
...
//}@dev
    ...
    cursorRequest["onsuccess"] = function() {
        ...
        if (r) {
            _updateFileList(that, r["id"], true, r["value"]["size"]);
            r["continue"]();
        } else {
            callback();
        }
...
function WMIndexedDBStorage_clear(callback) {
    ...
    request["onerror"] = _finished;
    request["onsuccess"] = _finished;
