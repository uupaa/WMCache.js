...
WMBlackholeStorage["prototype"] = {
    ...
    "size":         WMBlackholeStorage_size,  // WMBlackholeStorage#size():Integer
...
// --- implements ------------------------------------------
function WMBlackholeStorage_has(/* id */) {
    return false;
}
...
function WMBlackholeStorage_size() {
    return 0;
}

function WMBlackholeStorage_store(id, blob, mime, size, callback) {
    if (callback) { callback(); }
}

function WMBlackholeStorage_fetch(id, callback) {
    callback();
}

function WMBlackholeStorage_drop(id, callback) {
    if (callback) { callback(); }
}
