...
//                       size,       // @arg Integer
//                       callback) { // @arg Function = null - callback(url:URLString, stored:Boolean):void
////{@dev
...
//            that._storage["store"](key, reader["result"], mime, size, function() {
//                callback(url, true);
//            });
//        };
//        reader["readAsArrayBuffer"](data);
//    } else {
//        this._storage["store"](key, data, mime, size, function() {
//            callback(url, true);
//        });
//    }
//}
