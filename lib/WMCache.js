...
// --- dependency modules ----------------------------------
var WMCacheControl = global["WMCacheControl"]; // Arrow and Deny control
var WMCacheProfile = global["WMCacheProfile"]; // DevTools profiler
//var XHR = global["XMLHttpRequest"] || global["WMXMLHttpRequest"];
...
WMCache["prototype"] = {
    ...
    "get":           WMCache_get,           // WMCache#get(url:URLString, callback:Function, options:Object = {}):this
    ...
    // --- convenient ---
    "getBlob":       WMCache_getBlob,       // WMCache#getBlob(url:URLString, callback:Function, options:Object = {}):this
    "getBlobURL":    WMCache_getBlobURL,    // WMCache#getBlobURL(url:URLString, callback:Function, options:Object = {}):this
    "getArrayBuffer":WMCache_getArrayBuffer,// WMCache#getArrayBuffer(url:URLString, callback:Function, options:Object = {}):this
    // --- debug ---
...
function WMCache_getBlob(url,       // @arg URLString
                         callback,  // @arg Function - callback(url:URLString, blob:Blob, mime:String, size:Integer):void
                         options) { // @arg Object = {} - { reget, cors, wait }
                                    // @ret this
    return this["get"](url, function(url, data, mime, size, cached) {
...
function WMCache_getBlobURL(url,       // @arg URLString
                            callback,  // @arg Function - callback(url:URLString, blobURL:BlobURLString, mime:String, size:Integer):void
                            options) { // @arg Object = {} - { reget, cors, wait }
                                       // @ret this
    return this["get"](url, function(url, data, mime, size, cached) {
        if (data instanceof ArrayBuffer) {
...
function WMCache_getArrayBuffer(url,       // @arg URLString
                                callback,  // @arg Function - callback(url:URLString, buffer:ArrayBuffer, mime:String, size:Integer):void
                                options) { // @arg Object = {} - { reget, cors, wait }
                                           // @ret this
    return this["get"](url, function(url, data, mime, size, cached) {
        if (data instanceof ArrayBuffer) {
